            ...
            <div id="formulario" class="d-flex justify-content-center">
                <div>
                    ...
                    <form action="" id="formulario-login" class="form-group">
                        ...
                        <input id="senha" style="width: 94%;display:inline;" type="password" class="form-control mb-3 mr-0" placeholder="Senha">
                        <i onclick="verSenha()" id="ver-senha" class="fas fa-eye"></i>
