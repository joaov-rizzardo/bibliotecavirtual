...
<nav class="navbar navbar-expand-sm fixed-top" id="navegacao">
        <div class="container">
            <a id="logo" class="navbar-brand" href="index.php"><i class="fas fa-book-open mr-2"></i>Biblioteca virtual</a>
