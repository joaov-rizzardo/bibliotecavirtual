    ...
    <section style="margin-top: 85px;">
        <div class="row">
            <?php
                ...
                $chamados = $chamado->recuperaChamadosUsuario($id_usuario);
            ...
            <div class="col-xl-2" id="chamado">
                ...
                <button onclick="visualizaChamado(<?=$chamado->id_chamado?>)" class="btn btn-outline-info">Visualizar chamado</button>
            </div>
